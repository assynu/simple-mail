...
import com.bartczakdawid.core.controls.presenter.PresenterView;

import javax.swing.*;
import java.awt.*;

public class EmailContent extends JPanel implements SelectedEmailChangeListener {
    private final PresenterView subjectComponent;
    private final PresenterView senderComponent;
    private final PresenterView receiverComponent;
    ...
    public EmailContent() {
        ...
        this.subjectComponent = new PresenterView("Subject", "Empty");
        this.senderComponent = new PresenterView("Sender", "Empty");
        this.receiverComponent = new PresenterView("Receiver", "Empty");
