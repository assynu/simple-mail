...
public class ContactDetailsView extends JFrame {
    private final TextInput<JTextField> firstNameInput;
    private final TextInput<JTextField> lastNameInput;
    private final TextInput<JTextField> emailInput;
    ...
    public ContactDetailsView(Contact contact) {
        ...
        this.firstNameInput = new TextInput<>("First name", new JTextField());
        this.lastNameInput = new TextInput<>("Last name", new JTextField());
        this.emailInput = new TextInput<>("Email", new JTextField());
